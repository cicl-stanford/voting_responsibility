...
p.exp1.surprise = ggplot(data = df.plot,
...
p.exp1.importance = ggplot(data = df.plot,
       mapping = aes(x = .data[[x]],
                     y = .data[[y]],
                     color = color,
                     label = trial)) +
...
p.exp2.selection = ggplot(data = df.plot,
       mapping = aes(x = .data[[x]],
                     y = .data[[y]])) +
  geom_abline(intercept = 0,
              slope = 1,
...
p.exp2.full = ggplot(data = df.plot,
       mapping = aes(x = .data[[x]],
                     y = .data[[y]])) +
  geom_abline(intercept = 0,
              slope = 1,
...
p.exp4.importance = ggpredict(fit.brm_exp4_responsibility_badness_dummy,
...
```{r, warning=FALSE}
p.exp4.surprise = ggpredict(fit.brm_exp4_responsibility_badness_dummy,
...
p.exp4.responsibility = ggplot(data = df.plot,
...
p.exp4.wrongfulness = ggplot(data = df.plot,
       mapping = aes(x = estimate,
                     y = .data[[y]])) +
  geom_abline(intercept = 0,
              slope = 1,
...
p.exp1.surprise + p.exp1.importance + 
  plot_layout(nrow = 1) + 
  plot_annotation(tag_levels = "a",
                  tag_suffix = ")") & 
  theme(plot.tag = element_text(face = "bold", size = 20))

# ggsave(file = "../../figures/plots/experiment1_combined_scatter.pdf",
#        width = 10,
#        height = 5)
```
## Figure 6 
...
```{r fig.height=5, fig.width=10}
p.exp2.selection + p.exp2.full + 
  plot_layout(nrow = 1) + 
  plot_annotation(tag_levels = "a",
                  tag_suffix = ")") & 
  theme(plot.tag = element_text(face = "bold", size = 20))

# ggsave(file = "../../figures/plots/experiment2_combined_scatter.pdf",
#        width = 10,
#        height = 5)
```
...
```{r fig.height=5, fig.width=10}
p.exp4.importance + p.exp4.surprise + 
  plot_layout(nrow = 1) + 
  plot_annotation(tag_levels = "a",
                  tag_suffix = ")") & 
  theme(plot.tag = element_text(face = "bold", size = 20))

# ggsave(file = "../../figures/plots/experiment4_combined_lines.pdf",
#        width = 10,
#        height = 5)
```
## Figure 12
...
```{r fig.height=5, fig.width=10}
p.exp4.responsibility + p.exp4.wrongfulness + 
  plot_layout(nrow = 1) + 
  plot_annotation(tag_levels = "a",
                  tag_suffix = ")") & 
  theme(plot.tag = element_text(face = "bold", size = 20))

# ggsave(file = "../../figures/plots/experiment4_combined_scatter.pdf",
#        width = 10,
#        height = 5)
```
